...
pub fn load_preset(name: &str) -> Config {
    match name {
        ...
        "Midnight Approach" => Config {
            system: SystemConfig { name: "lorenz".into(), dt: 0.001, speed: 0.3 },
            sonification: SonificationConfig {
                mode: "direct".into(), scale: "pentatonic".into(),
                base_frequency: 55.0, octave_range: 2.0,
            ...
            audio: AudioConfig {
                reverb_wet: 0.82, delay_ms: 500.0, delay_feedback: 0.4,
                master_volume: 0.70, bit_depth: 24.0, rate_crush: 0.0,
                chorus_mix: 0.3, chorus_rate: 0.12, chorus_depth: 0.5,
                waveshaper_drive: 1.0, waveshaper_mix: 0.0,
                ..Default::default()
            },
        ...
        "Collapsing Cathedral" => Config {
            system: SystemConfig { name: "lorenz".into(), dt: 0.001, speed: 0.6 },
            sonification: SonificationConfig {
                mode: "spectral".into(), scale: "chromatic".into(),
                base_frequency: 65.0, octave_range: 3.5,
                chord_mode: "minor".into(), transpose_semitones: 0.0,
                voice_levels: [1.0, 0.8, 0.6, 0.4], portamento_ms: 400.0,
                voice_shapes: ["sine".into(), "sine".into(), "sine".into(), "sine".into()],
            },
            audio: AudioConfig {
                reverb_wet: 0.88, delay_ms: 800.0, delay_feedback: 0.5,
                master_volume: 0.72, bit_depth: 24.0, rate_crush: 0.0,
                chorus_mix: 0.2, chorus_rate: 0.1, chorus_depth: 0.4,
                waveshaper_drive: 1.0, waveshaper_mix: 0.0,
                ..Default::default()
            },
            lorenz: LorenzConfig { sigma: 14.0, rho: 35.0, beta: 2.6667 },
            ..Default::default()
        },

        "The Irrational Winding" => Config {
            system: SystemConfig { name: "geodesic_torus".into(), dt: 0.005, speed: 0.4 },
            sonification: SonificationConfig {
            ...
            audio: AudioConfig {
                reverb_wet: 0.78, delay_ms: 600.0, delay_feedback: 0.4,
        ...
        "Breathing Galaxy" => Config {
            system: SystemConfig { name: "halvorsen".into(), dt: 0.001, speed: 0.5 },
            sonification: SonificationConfig {
                mode: "spectral".into(), scale: "pentatonic".into(),
                base_frequency: 110.0, octave_range: 3.0,
                chord_mode: "sus2".into(), transpose_semitones: 0.0,
                voice_levels: [1.0, 0.8, 0.6, 0.4], portamento_ms: 500.0,
                voice_shapes: ["sine".into(), "sine".into(), "sine".into(), "sine".into()],
            },
            audio: AudioConfig {
                reverb_wet: 0.75, delay_ms: 600.0, delay_feedback: 0.35,
                master_volume: 0.70, bit_depth: 24.0, rate_crush: 0.0,
                chorus_mix: 0.5, chorus_rate: 0.12, chorus_depth: 0.6,
                waveshaper_drive: 1.0, waveshaper_mix: 0.0,
                ..Default::default()
            },
        ...
        "Throat of the Storm" => Config {
            system: SystemConfig { name: "lorenz".into(), dt: 0.001, speed: 1.2 },
            sonification: SonificationConfig {
                mode: "vocal".into(), scale: "chromatic".into(),
                base_frequency: 120.0, octave_range: 2.0,
                chord_mode: "none".into(), transpose_semitones: 0.0,
                voice_levels: [1.0, 0.6, 0.4, 0.2], portamento_ms: 200.0,
                voice_shapes: ["sine".into(), "sine".into(), "sine".into(), "sine".into()],
            },
            audio: AudioConfig {
                reverb_wet: 0.65, delay_ms: 300.0, delay_feedback: 0.3,
                master_volume: 0.72, bit_depth: 24.0, rate_crush: 0.0,
                chorus_mix: 0.4, chorus_rate: 0.2, chorus_depth: 0.5,
                waveshaper_drive: 1.0, waveshaper_mix: 0.0,
                ..Default::default()
            },
            lorenz: LorenzConfig { sigma: 18.0, rho: 40.0, beta: 2.6667 },
            ..Default::default()
        },

        "Siren Call" => Config {
            system: SystemConfig { name: "rossler".into(), dt: 0.002, speed: 0.7 },
            sonification: SonificationConfig {
                mode: "vocal".into(), scale: "pentatonic".into(),
                base_frequency: 200.0, octave_range: 2.0,
                chord_mode: "none".into(), transpose_semitones: 0.0,
                voice_levels: [1.0, 0.5, 0.3, 0.1], portamento_ms: 350.0,
                voice_shapes: ["sine".into(), "sine".into(), "sine".into(), "sine".into()],
            },
            audio: AudioConfig {
                reverb_wet: 0.70, delay_ms: 400.0, delay_feedback: 0.35,
                master_volume: 0.70, bit_depth: 24.0, rate_crush: 0.0,
        ...
        "Frozen Machinery" => Config {
            ...
            sonification: SonificationConfig {
                ...
                base_frequency: 110.0, octave_range: 2.0,
                chord_mode: "none".into(), transpose_semitones: 0.0,
                voice_levels: [1.0, 0.7, 0.5, 0.3], portamento_ms: 50.0,
                voice_shapes: ["saw".into(), "saw".into(), "triangle".into(), "sine".into()],
            },
            audio: AudioConfig {
                reverb_wet: 0.20, delay_ms: 200.0, delay_feedback: 0.35,
                master_volume: 0.78, bit_depth: 8.0, rate_crush: 0.0,
                chorus_mix: 0.1, chorus_rate: 0.5, chorus_depth: 0.3,
                waveshaper_drive: 3.0, waveshaper_mix: 0.6,
                ..Default::default()
            },
        ...
        "The Phase Transition" => Config {
            ...
            sonification: SonificationConfig {
                ...
                chord_mode: "none".into(), transpose_semitones: 0.0,
                voice_levels: [1.0, 0.8, 0.8, 0.8], portamento_ms: 150.0,
                voice_shapes: ["sine".into(), "sine".into(), "sine".into(), "sine".into()],
            },
            audio: AudioConfig {
                reverb_wet: 0.40, delay_ms: 250.0, delay_feedback: 0.3,
                master_volume: 0.72, bit_depth: 24.0, rate_crush: 0.0,
                chorus_mix: 0.3, chorus_rate: 0.3, chorus_depth: 0.4,
                waveshaper_drive: 1.0, waveshaper_mix: 0.0,
                ..Default::default()
            },
            kuramoto: KuramotoConfig { n_oscillators: 8, coupling: 1.3 },
            ..Default::default()
        },

        "Clockwork Insect" => Config {
            system: SystemConfig { name: "van_der_pol".into(), dt: 0.001, speed: 2.5 },
            sonification: SonificationConfig {
                mode: "direct".into(), scale: "chromatic".into(),
                base_frequency: 180.0, octave_range: 2.0,
                chord_mode: "none".into(), transpose_semitones: 0.0,
                voice_levels: [1.0, 0.5, 0.3, 0.1], portamento_ms: 20.0,
                voice_shapes: ["saw".into(), "saw".into(), "triangle".into(), "sine".into()],
            },
            audio: AudioConfig {
                reverb_wet: 0.15, delay_ms: 120.0, delay_feedback: 0.3,
                master_volume: 0.75, bit_depth: 10.0, rate_crush: 0.2,
                chorus_mix: 0.1, chorus_rate: 1.0, chorus_depth: 0.2,
                waveshaper_drive: 4.0, waveshaper_mix: 0.5,
                ..Default::default()
            },
        ...
        "Planetary Clockwork" => Config {
            system: SystemConfig { name: "three_body".into(), dt: 0.001, speed: 0.8 },
            sonification: SonificationConfig {
                mode: "orbital".into(), scale: "just_intonation".into(),
                base_frequency: 110.0, octave_range: 3.0,
                chord_mode: "dom7".into(), transpose_semitones: 0.0,
                voice_levels: [1.0, 0.9, 0.7, 0.5], portamento_ms: 200.0,
                voice_shapes: ["sine".into(), "sine".into(), "triangle".into(), "sine".into()],
            },
            audio: AudioConfig {
                reverb_wet: 0.55, delay_ms: 400.0, delay_feedback: 0.4,
                master_volume: 0.72, bit_depth: 24.0, rate_crush: 0.0,
                chorus_mix: 0.2, chorus_rate: 0.2, chorus_depth: 0.4,
                waveshaper_drive: 1.0, waveshaper_mix: 0.0,
                ..Default::default()
            },
            ..Default::default()
        ...
        "Industrial Heartbeat" => Config {
            system: SystemConfig { name: "double_pendulum".into(), dt: 0.001, speed: 1.5 },
            sonification: SonificationConfig {
                mode: "direct".into(), scale: "pentatonic".into(),
                base_frequency: 80.0, octave_range: 2.5,
                chord_mode: "power".into(), transpose_semitones: 0.0,
                voice_levels: [1.0, 0.7, 0.5, 0.3], portamento_ms: 30.0,
                voice_shapes: ["saw".into(), "triangle".into(), "sine".into(), "sine".into()],
            },
            audio: AudioConfig {
                reverb_wet: 0.30, delay_ms: 180.0, delay_feedback: 0.35,
                master_volume: 0.76, bit_depth: 10.0, rate_crush: 0.0,
                chorus_mix: 0.1, chorus_rate: 0.5, chorus_depth: 0.3,
                waveshaper_drive: 3.5, waveshaper_mix: 0.7,
                ..Default::default()
            },
            ..Default::default()
        },
        ...
        "Bone Structure" => Config {
            system: SystemConfig { name: "chua".into(), dt: 0.0005, speed: 1.8 },
            sonification: SonificationConfig {
                mode: "direct".into(), scale: "pentatonic".into(),
                base_frequency: 110.0, octave_range: 2.5,
                chord_mode: "none".into(), transpose_semitones: 0.0,
                voice_levels: [1.0, 0.8, 0.5, 0.3], portamento_ms: 40.0,
                voice_shapes: ["sine".into(), "triangle".into(), "sine".into(), "sine".into()],
            },
            audio: AudioConfig {
                reverb_wet: 0.35, delay_ms: 200.0, delay_feedback: 0.35,
                master_volume: 0.74, bit_depth: 24.0, rate_crush: 0.0,
                chorus_mix: 0.15, chorus_rate: 0.4, chorus_depth: 0.3,
                waveshaper_drive: 2.0, waveshaper_mix: 0.4,
                ..Default::default()
            },
        ...
        "Glass Harp" => Config {
            system: SystemConfig { name: "aizawa".into(), dt: 0.002, speed: 1.0 },
            sonification: SonificationConfig {
                mode: "direct".into(), scale: "pentatonic".into(),
                base_frequency: 440.0, octave_range: 3.0,
                chord_mode: "none".into(), transpose_semitones: 0.0,
                voice_levels: [1.0, 0.0, 0.0, 0.0], portamento_ms: 250.0,
                voice_shapes: ["sine".into(), "sine".into(), "sine".into(), "sine".into()],
            },
            audio: AudioConfig {
                reverb_wet: 0.60, delay_ms: 300.0, delay_feedback: 0.3,
                master_volume: 0.68, bit_depth: 24.0, rate_crush: 0.0,
        ...
        "Electric Kelp" => Config {
            system: SystemConfig { name: "rossler".into(), dt: 0.002, speed: 0.9 },
            sonification: SonificationConfig {
                mode: "fm".into(), scale: "pentatonic".into(),
                base_frequency: 110.0, octave_range: 3.0,
                chord_mode: "none".into(), transpose_semitones: 0.0,
                voice_levels: [1.0, 0.6, 0.4, 0.2], portamento_ms: 180.0,
                voice_shapes: ["sine".into(), "sine".into(), "sine".into(), "sine".into()],
            },
            audio: AudioConfig {
                reverb_wet: 0.58, delay_ms: 350.0, delay_feedback: 0.35,
                master_volume: 0.70, bit_depth: 24.0, rate_crush: 0.0,
                chorus_mix: 0.4, chorus_rate: 0.18, chorus_depth: 0.5,
                waveshaper_drive: 1.0, waveshaper_mix: 0.0,
                ..Default::default()
            },
            rossler: RosslerConfig { a: 0.15, b: 0.2, c: 7.0 },
            ..Default::default()
        },
        ...
        "The Butterfly's Aria" => Config {
            ...
            sonification: SonificationConfig {
                mode: "orbital".into(), scale: "pentatonic".into(),
                base_frequency: 220.0, octave_range: 2.5,
                chord_mode: "none".into(), transpose_semitones: 0.0,
                voice_levels: [1.0, 0.6, 0.4, 0.2], portamento_ms: 300.0,
                voice_shapes: ["sine".into(), "sine".into(), "sine".into(), "sine".into()],
            },
            audio: AudioConfig {
                reverb_wet: 0.62, delay_ms: 350.0, delay_feedback: 0.35,
                master_volume: 0.70, bit_depth: 24.0, rate_crush: 0.0,
                chorus_mix: 0.3, chorus_rate: 0.15, chorus_depth: 0.4,
                waveshaper_drive: 1.0, waveshaper_mix: 0.0,
                ..Default::default()
            },
            lorenz: LorenzConfig { sigma: 10.0, rho: 24.5, beta: 2.6667 },
            ..Default::default()
        },

        "Solar Wind" => Config {
            system: SystemConfig { name: "halvorsen".into(), dt: 0.001, speed: 1.3 },
            sonification: SonificationConfig {
                mode: "fm".into(), scale: "chromatic".into(),
                base_frequency: 220.0, octave_range: 3.0,
                chord_mode: "none".into(), transpose_semitones: 0.0,
                voice_levels: [1.0, 0.7, 0.5, 0.3], portamento_ms: 120.0,
                voice_shapes: ["sine".into(), "sine".into(), "sine".into(), "sine".into()],
            },
            audio: AudioConfig {
                reverb_wet: 0.55, delay_ms: 250.0, delay_feedback: 0.3,
                master_volume: 0.72, bit_depth: 24.0, rate_crush: 0.0,
                chorus_mix: 0.6, chorus_rate: 0.2, chorus_depth: 0.6,
                waveshaper_drive: 1.0, waveshaper_mix: 0.0,
                ..Default::default()
            },
        ...
        "Möbius Lead" => Config {
            system: SystemConfig { name: "aizawa".into(), dt: 0.002, speed: 1.4 },
            sonification: SonificationConfig {
                mode: "orbital".into(), scale: "chromatic".into(),
                base_frequency: 330.0, octave_range: 2.5,
                chord_mode: "none".into(), transpose_semitones: 0.0,
                voice_levels: [1.0, 0.0, 0.0, 0.0], portamento_ms: 200.0,
                voice_shapes: ["sine".into(), "sine".into(), "sine".into(), "sine".into()],
            },
            audio: AudioConfig {
                reverb_wet: 0.45, delay_ms: 280.0, delay_feedback: 0.3,
                master_volume: 0.70, bit_depth: 24.0, rate_crush: 0.0,
                chorus_mix: 0.2, chorus_rate: 0.25, chorus_depth: 0.3,
                waveshaper_drive: 1.0, waveshaper_mix: 0.0,
                ..Default::default()
            },
            aizawa: AizawaConfig { a: 0.95, b: 0.7, c: 0.6, d: 3.5, e: 0.25, f: 0.1 },
        ...
        "Last Light" => Config {
            system: SystemConfig { name: "rossler".into(), dt: 0.002, speed: 0.5 },
            sonification: SonificationConfig {
                mode: "spectral".into(), scale: "just_intonation".into(),
                base_frequency: 82.0, octave_range: 3.5,
                chord_mode: "major".into(), transpose_semitones: 0.0,
                voice_levels: [1.0, 0.9, 0.7, 0.5], portamento_ms: 600.0,
                voice_shapes: ["sine".into(), "sine".into(), "sine".into(), "sine".into()],
            },
            audio: AudioConfig {
                reverb_wet: 0.85, delay_ms: 700.0, delay_feedback: 0.55,
                master_volume: 0.68, bit_depth: 24.0, rate_crush: 0.0,
                chorus_mix: 0.2, chorus_rate: 0.08, chorus_depth: 0.5,
                waveshaper_drive: 1.0, waveshaper_mix: 0.0,
                ..Default::default()
            },
        ...
        "Seismic Event" => Config {
            system: SystemConfig { name: "three_body".into(), dt: 0.001, speed: 0.6 },
            sonification: SonificationConfig {
                mode: "direct".into(), scale: "pentatonic".into(),
                base_frequency: 50.0, octave_range: 2.0,
                chord_mode: "power".into(), transpose_semitones: 0.0,
                voice_levels: [1.0, 0.8, 0.6, 0.3], portamento_ms: 200.0,
                voice_shapes: ["sine".into(), "sine".into(), "sine".into(), "sine".into()],
            },
            audio: AudioConfig {
                reverb_wet: 0.60, delay_ms: 500.0, delay_feedback: 0.4,
                master_volume: 0.72, bit_depth: 24.0, rate_crush: 0.0,
                chorus_mix: 0.2, chorus_rate: 0.08, chorus_depth: 0.4,
                waveshaper_drive: 2.5, waveshaper_mix: 0.4,
                ..Default::default()
            },
            ..Default::default()
        },
        ...
        "Ancient Algorithm" => Config {
            ...
            sonification: SonificationConfig {
                ...
                base_frequency: 100.0, octave_range: 4.0,
                chord_mode: "none".into(), transpose_semitones: 0.0,
                voice_levels: [1.0, 0.8, 0.6, 0.4], portamento_ms: 400.0,
                voice_shapes: ["sine".into(), "sine".into(), "sine".into(), "sine".into()],
            },
            audio: AudioConfig {
                reverb_wet: 0.80, delay_ms: 600.0, delay_feedback: 0.5,
                master_volume: 0.70, bit_depth: 24.0, rate_crush: 0.0,
                chorus_mix: 0.3, chorus_rate: 0.1, chorus_depth: 0.4,
                waveshaper_drive: 1.0, waveshaper_mix: 0.0,
                ..Default::default()
            },
            ..Default::default()
        ...
        "Cathedral Organ" => Config {
            ...
            audio: AudioConfig {
                reverb_wet: 0.82, delay_ms: 450.0, delay_feedback: 0.4,
                master_volume: 0.72, bit_depth: 24.0, rate_crush: 0.0,
                chorus_mix: 0.25, chorus_rate: 0.1, chorus_depth: 0.45,
                waveshaper_drive: 1.0, waveshaper_mix: 0.0,
                ..Default::default()
            },
            lorenz: LorenzConfig { sigma: 10.0, rho: 28.0, beta: 2.6667 },
        ...
        "Neon Labyrinth" => Config {
            ...
            sonification: SonificationConfig {
                mode: "spectral".into(), scale: "chromatic".into(),
                base_frequency: 200.0, octave_range: 4.0,
                chord_mode: "none".into(), transpose_semitones: 0.0,
                voice_levels: [1.0, 0.8, 0.6, 0.4], portamento_ms: 80.0,
                voice_shapes: ["saw".into(), "saw".into(), "triangle".into(), "sine".into()],
            },
            audio: AudioConfig {
                reverb_wet: 0.40, delay_ms: 150.0, delay_feedback: 0.5,
                master_volume: 0.70, bit_depth: 12.0, rate_crush: 0.15,
                chorus_mix: 0.2, chorus_rate: 1.0, chorus_depth: 0.4,
                waveshaper_drive: 1.0, waveshaper_mix: 0.0,
                ..Default::default()
            },
            chua: ChuaConfig { alpha: 15.6, beta: 28.0, m0: -1.143, m1: -0.714 },
        ...
        "Dissociation" => Config {
            ...
            audio: AudioConfig {
                reverb_wet: 0.45, delay_ms: 100.0, delay_feedback: 0.5,
                master_volume: 0.72, bit_depth: 10.0, rate_crush: 0.2,
                chorus_mix: 0.2, chorus_rate: 2.0, chorus_depth: 0.4,
                waveshaper_drive: 1.0, waveshaper_mix: 0.0,
                ..Default::default()
            },
            ..Default::default()
        ...
        "Tungsten Filament" => Config {
            ...
            sonification: SonificationConfig {
                ...
                chord_mode: "none".into(), transpose_semitones: 0.0,
                voice_levels: [1.0, 0.8, 0.6, 0.4], portamento_ms: 60.0,
                voice_shapes: ["saw".into(), "saw".into(), "triangle".into(), "sine".into()],
            },
            audio: AudioConfig {
                reverb_wet: 0.30, delay_ms: 150.0, delay_feedback: 0.4,
                master_volume: 0.72, bit_depth: 14.0, rate_crush: 0.0,
                chorus_mix: 0.15, chorus_rate: 0.8, chorus_depth: 0.3,
                waveshaper_drive: 7.0, waveshaper_mix: 0.8,
                ..Default::default()
            },
            chua: ChuaConfig { alpha: 15.6, beta: 28.0, m0: -1.143, m1: -0.714 },
            ..Default::default()
        ...
        "The Double Scroll" => Config {
            system: SystemConfig { name: "chua".into(), dt: 0.0005, speed: 2.0 },
            sonification: SonificationConfig {
                mode: "orbital".into(), scale: "chromatic".into(),
                base_frequency: 150.0, octave_range: 3.5,
                chord_mode: "none".into(), transpose_semitones: 0.0,
                voice_levels: [1.0, 0.7, 0.5, 0.3], portamento_ms: 40.0,
                voice_shapes: ["saw".into(), "saw".into(), "triangle".into(), "sine".into()],
            },
            audio: AudioConfig {
                reverb_wet: 0.25, delay_ms: 120.0, delay_feedback: 0.45,
                master_volume: 0.74, bit_depth: 24.0, rate_crush: 0.0,
                chorus_mix: 0.15, chorus_rate: 0.6, chorus_depth: 0.3,
                waveshaper_drive: 5.0, waveshaper_mix: 0.7,
                ..Default::default()
            },
            chua: ChuaConfig { alpha: 15.6, beta: 28.0, m0: -1.143, m1: -0.714 },
            ..Default::default()
        ...
        "Memory of Water" => Config {
            system: SystemConfig { name: "lorenz".into(), dt: 0.0005, speed: 0.4 },
            sonification: SonificationConfig {
                mode: "direct".into(), scale: "just_intonation".into(),
                base_frequency: 55.0, octave_range: 2.0,
                chord_mode: "major".into(), transpose_semitones: 0.0,
                voice_levels: [1.0, 0.7, 0.5, 0.3], portamento_ms: 1000.0,
                voice_shapes: ["sine".into(), "sine".into(), "sine".into(), "sine".into()],
            },
            audio: AudioConfig {
                reverb_wet: 0.88, delay_ms: 900.0, delay_feedback: 0.6,
                master_volume: 0.65, bit_depth: 24.0, rate_crush: 0.0,
                chorus_mix: 0.3, chorus_rate: 0.06, chorus_depth: 0.6,
                waveshaper_drive: 1.0, waveshaper_mix: 0.0,
                ..Default::default()
            },
            lorenz: LorenzConfig { sigma: 10.0, rho: 28.0, beta: 2.6667 },
        ...
        "Monk's Bell" => Config {
            system: SystemConfig { name: "double_pendulum".into(), dt: 0.001, speed: 0.7 },
            sonification: SonificationConfig {
                mode: "direct".into(), scale: "pentatonic".into(),
                base_frequency: 200.0, octave_range: 2.0,
                chord_mode: "none".into(), transpose_semitones: 0.0,
                voice_levels: [1.0, 0.6, 0.3, 0.1], portamento_ms: 500.0,
                voice_shapes: ["sine".into(), "sine".into(), "sine".into(), "sine".into()],
            },
            audio: AudioConfig {
        ...
        "Deep Hypnosis" => Config {
            ...
            sonification: SonificationConfig {
                ...
                chord_mode: "major".into(), transpose_semitones: 0.0,
                voice_levels: [1.0, 0.7, 0.5, 0.3], portamento_ms: 1500.0,
                voice_shapes: ["sine".into(), "sine".into(), "sine".into(), "sine".into()],
            },
            audio: AudioConfig {
                reverb_wet: 0.90, delay_ms: 1200.0, delay_feedback: 0.65,
                master_volume: 0.62, bit_depth: 24.0, rate_crush: 0.0,
                chorus_mix: 0.25, chorus_rate: 0.04, chorus_depth: 0.65,
                waveshaper_drive: 1.0, waveshaper_mix: 0.0,
                ..Default::default()
            },
        ...
        "Aurora Borealis" => Config {
            ...
            sonification: SonificationConfig {
                ...
                base_frequency: 110.0, octave_range: 3.0,
                chord_mode: "none".into(), transpose_semitones: 0.0,
                voice_levels: [1.0, 0.7, 0.5, 0.3], portamento_ms: 400.0,
                voice_shapes: ["sine".into(), "sine".into(), "sine".into(), "sine".into()],
            },
            audio: AudioConfig {
                reverb_wet: 0.78, delay_ms: 400.0, delay_feedback: 0.4,
                master_volume: 0.70, bit_depth: 24.0, rate_crush: 0.0,
                chorus_mix: 0.7, chorus_rate: 0.15, chorus_depth: 0.7,
                waveshaper_drive: 1.0, waveshaper_mix: 0.0,
                ..Default::default()
            },
            lorenz: LorenzConfig { sigma: 12.0, rho: 30.0, beta: 2.6667 },
            ..Default::default()
        },
        ...
        "The Synchronization" => Config {
            ...
            sonification: SonificationConfig {
                mode: "direct".into(), scale: "pentatonic".into(),
                base_frequency: 165.0, octave_range: 2.5,
                chord_mode: "major".into(), transpose_semitones: 0.0,
                voice_levels: [1.0, 0.8, 0.8, 0.8], portamento_ms: 200.0,
                voice_shapes: ["sine".into(), "sine".into(), "sine".into(), "sine".into()],
            },
            audio: AudioConfig {
                reverb_wet: 0.55, delay_ms: 300.0, delay_feedback: 0.35,
                master_volume: 0.72, bit_depth: 24.0, rate_crush: 0.0,
                chorus_mix: 0.35, chorus_rate: 0.2, chorus_depth: 0.4,
                waveshaper_drive: 1.0, waveshaper_mix: 0.0,
                ..Default::default()
            },
            kuramoto: KuramotoConfig { n_oscillators: 8, coupling: 2.5 },
            ..Default::default()
        },
